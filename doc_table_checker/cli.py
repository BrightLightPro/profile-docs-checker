...
def optional_int(value: str | None):
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate fixed-template PDF document identification tables against an Excel master list."
    )
    ...
    parser.add_argument("--ausgabe", required=True, help="Expected Ausgabe as MM.YYYY, e.g. 07.2026.")
    ...
    parser.add_argument("--table-index", type=int, default=None, help="Optional 1-based table number on the page. Default: auto.")
    parser.add_argument("--row-start", type=int, default=None, help="Optional 1-based row in detected table where Dokumentname starts. Default: auto.")
    parser.add_argument("--preview", action="store_true", help="Preview extraction from the first few PDFs instead of running validation.")

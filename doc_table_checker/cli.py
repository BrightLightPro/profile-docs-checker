...
def main() -> int:
    ...
    parser.add_argument("--word", default=None, help="Optional Word .docx file containing the document list table.")
    parser.add_argument("--word-mapping", default=None, help="Optional mapping JSON created/edited from the Word inspector.")
